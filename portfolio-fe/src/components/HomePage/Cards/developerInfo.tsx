...
const TOTAL_LINES = 8 + coderData.skills.length;

const CoderProfileCard = React.memo(() => {
  return (
...
if (
  ...
  !document.getElementById("developer-info-styles")
) {
  const styleSheet = document.createElement("style");
  styleSheet.id = "developer-info-styles";
